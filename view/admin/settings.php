...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <form action="/admin/settings" method="POST" enctype="multipart/form-data" class="row g-3 w-50 mx-auto mt-5 p-4 bg-light shadow-sm rounded">
                <h5 class="text-center text-success mb-4">Settings</h5>
                <div class="col-md-6">
                    <label for="images" class="form-label text-success">
                        <i class="bi bi-people-fill"></i> İmages
                    </label>
                    <input type="file" name="images" id="images" class="form-control border-success shadow-sm">
                </div>
                <div class="col-md-6">
