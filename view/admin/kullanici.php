    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                                ...
                                <div class="row text-center">
                                    <div class="col-6">
                                        <div class="button"><button type="button" class="btn bg-primary text-white"
                                                ...
                                                data-bs-target="#usersUpdateModal<?php echo $value['id']; ?>">Düzenle</button></div>
                                    </div>
                                    <div class="col-6">
            ...
            <div class="container mt-5">
                ...
                <div class="modal fade" id="usersUpdateModal<?php echo $value['id']; ?>" tabindex="-1" aria-labelledby="userCreateModal"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/admin/update/<?php echo $value['id']; ?>" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="role_id" name="role_id">
                                            <option value="1" <?php if($value['role_id'] == 1){ print 'selected';} ?>>Admin</option>
                                            <option value="2" <?php if($value['role_id'] == 2){ print 'selected';} ?>>Kullanıcı</option>
                                            <option value="3" <?php if($value['role_id'] == 3){ print 'selected';} ?>>Misafir</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="user_status" name="user_status">
                                            <option value="1" <?php if($value['user_status'] == 1){print'selected';} ?>>Aktif</option>
                                            <option value="0" <?php if($value['user_status'] == 0){print'selected';} ?>>Pasif</option>
                                        </select>
                                    </div>
