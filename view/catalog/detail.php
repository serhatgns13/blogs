                                                                ...
                                                                <div class="post-author hstack gap-1">
                                                                    <a href="page-author.html"
                                                                        data-uc-tooltip="Jason Blake"><img
                                                                            src="view/catalog/assets/images/avatars/05.png"
                                                                            alt="Jason Blake"
                                                                ...
                                                                <div class="post-author hstack gap-1">
                                                                    <a href="page-author.html"
                                                                        data-uc-tooltip="Nisi Nyung"><img
                                                                            src="view/catalog/assets/images/avatars/08.png"
                                                                            alt="Nisi Nyung"
                                                                            class="w-24px h-24px rounded-circle"></a>
                                                                    <a href="page-author.html"
                                                                ...
                                                                <div class="post-author hstack gap-1">
                                                                    <a href="page-author.html"
                                                                        data-uc-tooltip="Rico Santos"><img
                                                                            src="view/catalog/assets/images/avatars/07.png"
                                                                            alt="Rico Santos"
                                                                            class="w-24px h-24px rounded-circle"></a>
                                                                    <a href="page-author.html"
                                                                ...
                                                                <div class="post-author hstack gap-1">
                                                                    <a href="page-author.html"
                                                                        data-uc-tooltip="Peter Sawyer"><img
                                                                            src="view/catalog/assets/images/avatars/02.png"
                                                                            alt="Peter Sawyer"
                                                                            class="w-24px h-24px rounded-circle"></a>
                                                                    <a href="page-author.html"
