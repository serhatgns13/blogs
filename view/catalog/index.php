                                                        ...
                                                        <div
                                                                ...
                                                                <div>
                                                                    <div class="post-category hstack gap-narrow fw-semibold">
                                                                        <a class="fw-medium text-none text-primary dark:text-primary-400"
                                                                            href="<?php echo APP_URL; ?>blog/<?php echo $value["slug"]; ?>"><?php print $value['name']; ?></a>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <h3
                                                                ...
                                                                <a class="text-none text-white"
                                                                    href="<?php echo APP_URL; ?>blog/<?php echo $value["slug"]; ?>"><?php print $value['title']; ?></a>
                                                            </h3>
                                                            <div>
                                                                <div
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <h3
                                                                    ...
                                                                    <a class="text-none text-white"
                                                                        href="<?php echo APP_URL; ?>detail/<?php echo $value["slug"]; ?>"><?php echo $value['title'] ?>
                                                                    </a>
                                                                </h3>
                                                                <div
                                                                    class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
...
?></span>
                                                ...
                                                <h3
                                                    ...
                                                    <a class="text-none text-white" href="<?php echo APP_URL; ?>detail/<?php echo $value["slug"]; ?>"><?php print $value['title']; ?>s</a>
                                                </h3>
                                                <div>
                                                    <div
                                                        class="post-meta panel hstack justify-between fs-7 fw-medium text-white text-opacity-60">
                                                    ...
                                                    <div class="row child-cols g-2" data-uc-grid>
                                                        <div class="col-auto">
                                                            <div
                                                                ...
                                                                <a href="<?php echo APP_URL; ?>detail/<?php echo $value["slug"]; ?>" class="position-cover"></a>
                                                            </div>
                                                        </div>
                                                        <div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            class="post-category hstack gap-narrow fw-semibold">
                                                                            <a class="fw-medium text-none text-primary dark:text-primary-400"
                                                                                href="<?php echo APP_URL; ?>blog/<?php echo $value["slug"]; ?>"><?php print $value['name'] ?>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                    <div class="sep d-none md:d-block">|</div>
...
?></span>
                                                                ...
                                                                <h3 class="post-title h6 lg:h5 m-0 text-truncate-2">
                                                                    <a class="text-none hover:text-primary duration-150"
                                                                        href="<?php echo APP_URL; ?>detail/<?php echo $value["slug"]; ?>"><?php  // Orijinal içerik
                                        ...
                                        <div class="post-header panel vstack gap-1">
                                            <div
                                                ...
                                                <div>
                                                    <div class="post-category hstack gap-narrow fw-semibold">
                                                        <a class="fw-medium text-none text-primary dark:text-primary-400"
                                                            href="<?php echo APP_URL; ?>blog/<?php echo $value["slug"]; ?>"><?php echo $value['name'] ?></a>
                                                    </div>
                                                </div>
                                                <div class="sep d-none md:d-block">|</div>
                                                <div class="d-none md:d-block">
